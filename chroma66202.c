...
void help(char *argv[])
{
  ...
  printf("                 Results bellow 0 means error, the meaning is");
  printf("                 following:\n");
  printf("                    -1  The first time integrated calculation\n");
  printf("                        is not complete yet.\n");
  printf("                    -2  Range change error when integration\n");
  printf("                        process is executing.\n");
  printf("                    -3  Over voltage range, Over current range,\n");
  printf("                        or over current protection. In such case\n");
  printf("                        you may need to reset the protection.\n");
