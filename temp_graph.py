...
class DataGen(object):
    ...
    def __init__(self, init=50):
        ...
        self.ser = serial.Serial('/dev/ttyUSB0',115200,timeout = 0.8)

    def next(self):
        self.ser.write('T\r')
        self.rawtemp = self.ser.readline()
        self.data = float(self.rawtemp.replace('C', ''))
        return self.data
